...
## Gate 2: Import-Integrität

1. Pflichtfelder nach lokalem Katalog-/Dateiimport:
   - `name`, `vintage`, `region`, `drink_start`, `drink_end`
2. Wenn in den Importdaten vorhanden, müssen persistiert sein:
...
1. Der Scanner arbeitet ausschließlich lokal mit der nativen Barcode-Erkennung und sendet keine Bilder.
2. Die lokale Katalogsuche darf keine Netzwerkrequests auslösen.
3. Beide Regeln sind durch Unit-Tests abzudecken.
